...
handler_wrapper_kwargs = {'function_name': 'cowin-notification-service-dev-subscribe', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('handler.subscribe')
