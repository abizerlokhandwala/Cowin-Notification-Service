...
handler_wrapper_kwargs = {'function_name': 'cowin-notification-service-dev-notif_dispatcher', 'timeout': 10}
try:
    user_handler = serverless_sdk.get_user_handler('handler.notif_dispatcher')
