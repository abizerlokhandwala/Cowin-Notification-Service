...
handler_wrapper_kwargs = {'function_name': 'cowin-notification-service-dev-trigger_district_updates', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('handler.trigger_district_updates')
