...
handler_wrapper_kwargs = {'function_name': 'cowin-notification-service-dev-update_district_slots', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('handler.update_district_slots')
