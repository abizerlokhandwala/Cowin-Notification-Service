...
handler_wrapper_kwargs = {'function_name': 'cowin-notification-service-dev-get_states', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('handler.get_states')
